...
$pageTitle = 'Contas a Receber - RMG ERP';
                ...
                <table class="table table-sm table-bordered mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Alternar filtro "Ocultar Recebidas"</td>
                        </tr>
                        <tr>
...
<script>
    ...
    $(document).on('keydown', function(e) {
        ...
        // Alt+R - Toggle filtro Ocultar Recebidas
        if (e.altKey && (e.key === 'r' || e.key === 'R')) {
            e.preventDefault();
            if (!isModalOpen()) {
                var chk = $('#chkOcultarRecebidas');
