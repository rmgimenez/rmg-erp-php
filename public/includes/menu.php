            ...
            <ul class="navbar-nav me-auto">
                ...
                <?php else: ?>
                    ...
                    <li class="nav-item">
                        ...
                        $rmg_pagar_alertas = (new ContaPagarDAO())->buscarVencidasEProximas($rmg_empresa_id, 10);
                        $rmg_receber_alertas = (new ContaReceberDAO())->buscarVencidasEProximas($rmg_empresa_id, 10);
